...
CATALOG: Final[dict[str, str]] = {
    **ZH_CATALOG,
    ...
    "water.query.rank.guided.intro": "水王榜單今依 主體 + 範圍 + 時間 而查。\n今將引君逐步擇定三維條件。\n第一步，請擇主體：{choices}\n若欲止之，發“取消”即可。",
    "water.query.rank.guided.subject_invalid": "主體所輸未合，請於三者中擇一：{choices}",
    "water.query.rank.guided.scope_prompt": "第二步，請擇範圍：{choices}",
    "water.query.rank.guided.scope_invalid": "範圍所輸未合，請依當前主體擇其合法者。",
    "water.query.rank.guided.period_prompt": "第三步，請擇時間：{choices}",
    "water.query.rank.guided.period_invalid": "時間所輸未合，請於諸項中擇一：{choices}",
    "water.query.rank.guided.summary": "已擇：{subject} / {scope} / {period}",
    "water.query.rank.error.legacy": "舊式已停用，請改用三維寫法，例如: {example}",
